...
def get_sklearn_tree(x:pd.DataFrame,classes:int):
    max_height,min_samples_leaf,min_samples_split,min_error_improvement = get_tree_parameters(x,classes)
    model = sklearn.tree.DecisionTreeClassifier(max_depth=max_height,min_samples_leaf=min_samples_leaf,min_samples_split=min_samples_split,min_impurity_decrease=min_error_improvement)

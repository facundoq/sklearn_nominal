...
def all_estimators(type_filter=None):
    """Get a list of all estimators from `sklearn_nominal`.
    ...
    Examples
    --------
    >>> from sklearn_nominal.utils.discovery import all_estimators
    ...
    all_classes = []
    root = str(Path(__file__).parent.parent)  # sklearn_nominal package
...
def all_displays():
    """Get a list of all displays from `sklearn_nominal`.
    ...
    Examples
    --------
    >>> from sklearn_nominal.utils.discovery import all_displays
...
def _is_checked_function(item):
    ...
    mod = item.__module__
    if not mod.startswith("sklearn_nominal.") or mod.endswith("estimator_checks"):
        return False
...
def all_functions():
    """Get a list of all functions from `sklearn_nominal`.
    ...
    Examples
    --------
    >>> from sklearn_nominal.utils.discovery import all_functions

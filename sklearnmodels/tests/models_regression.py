...
from sklearnmodels.scikit.rule_cn2 import CN2Regressor
from sklearnmodels.scikit.rule_oner import OneRRegressor
from sklearnmodels.scikit.rule_zeror import ZeroRRegressor
